...
Defines the backend authentication contract: cookie-based SPA auth via Sanctum, Fortify-driven login/register/password reset endpoints, password confirmation for sensitive operations, and the two-factor authentication feature that the SPA consumes.
## Requirements
