...
<template>
  <BasicPage title="Roles & Permissions" description="Manage roles and their permissions">
    <div class="flex flex-col items-center justify-center rounded-lg border border-dashed py-16 text-center">
      ...
      <p class="text-sm text-muted-foreground">Role management will be available in a future update.</p>
    </div>
  </BasicPage>
</template>
